...
export const sendVerificationMail = (senderEmail, verificationString) => {
    ...
    const verificationLink = `https://timzzz.netlify.app/activation/${verificationString}`;
...
export const mail = (senderEmail, verificationString) => {
    ...
    // Generate the password reset link
    const resetLink = `https://timzzz.netlify.app/reset-password/${verificationString}`;
...
export const customMail = (sendereName, senderEmail, senderMessage) => {
